...
import com.attafitamim.nfc.data.utils.readFromJson
import com.attafitamim.nfc.data.utils.serializeToJsonBytes
...
class AESCryptoHandler : ICryptoHandler {
    ...
    override suspend fun <T> encrypt(
        ...
        val dataBytes = data.serializeToJsonBytes()
    ...
    private class EncryptedDataSpec(
        ...
        override fun toString(): String {
            val jsonData = this.serializeToJsonBytes()
